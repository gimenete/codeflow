...
export const Route = createFileRoute(
  ...
  beforeLoad: ({ params }) => {
    ...
    return { account, owner: params.owner, repo: params.repo };
  },
  component: AccountIssueDetail,
});

function AccountIssueDetail() {
  const { number } = Route.useParams();
  const { account, owner, repo } = Route.useRouteContext();
